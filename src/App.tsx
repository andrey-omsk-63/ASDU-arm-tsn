...
const App = () => {
  ...
  const InputNewDateInterval = () => {
    ...
    const handleChangeDP = (event: any) => {
      ...
      //   console.log('event Invalid Date');
      // } else {
      //   console.log('event !!!', tekYear - event.getFullYear());
      //   if (tekYear - event.getFullYear() <= 5) {
      //     console.log('event OK');
      //     eventInp = event;
      //     setValueDate(eventInp);
      //     inpDate = true;
      //     console.log('eventInp:', inpDate, eventInp, typeof eventInp);
      //     //setTrigger(!trigger);
      //   }
      // }
    ...
    return (
      <>
        <Grid item container sx={{ border: 0, marginRight: 0.3, width: '140px' }}>
