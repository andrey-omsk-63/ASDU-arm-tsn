...
import { styleApp02, styleBoxFormInt } from "./AppStyle";
...
const App = () => {
  ...
  const InputNewDate = () => {
    ...
    const InputInterval = (props: { curr: any; func: any }) => {
    ...
    return (
      <>
        <Grid item container sx={{ border: 0, width: "150px" }}>
          ...
          <Grid item xs={5}>
            <Box sx={styleInt01}>
              <InputInterval curr={currencies} func={handleChangeInt} />
            </Box>
          </Grid>
        </Grid>
